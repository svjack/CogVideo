...
parser.add_argument("--quantization_scheme", type=str, default="fp8", choices=["int8", "fp8"], help="The quantization scheme to use (int8, fp8)")
...
# 初始化管道
###pipe = CogVideoXPipeline.from_pretrained("THUDM/CogVideoX-5b", text_encoder=text_encoder, transformer=transformer, vae=vae, torch_dtype=dtype).to("cpu")
...
python t2v_app_q.py --quantization_scheme int8 --dtype bfloat16
python t2v_app_q.py --quantization_scheme fp8 --dtype bfloat16
'''
